...
func (_m *Collection) Delete(ctx context.Context, filter interface{}) error {
...
func (_m *Collection) Update(ctx context.Context, filter interface{}, update interface{}) error {
