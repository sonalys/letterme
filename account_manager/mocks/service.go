...
func (_m *Service) CreateAccount(ctx context.Context, account models.Account) (cryptography.EncryptedBuffer, error) {
	ret := _m.Called(ctx, account)

	var r0 cryptography.EncryptedBuffer
	if rf, ok := ret.Get(0).(func(context.Context, models.Account) cryptography.EncryptedBuffer); ok {
		r0 = rf(ctx, account)
	} else {
		r0 = ret.Get(0).(cryptography.EncryptedBuffer)
	}
...
// ResetPublicKey provides a mock function with given fields: ctx, accountID
func (_m *Service) ResetPublicKey(ctx context.Context, accountID models.DatabaseID) (*models.Account, error) {
	ret := _m.Called(ctx, accountID)

	var r0 *models.Account
	if rf, ok := ret.Get(0).(func(context.Context, models.DatabaseID) *models.Account); ok {
		r0 = rf(ctx, accountID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Account)
